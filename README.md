...
- [x] 添加更多 API 端点【2.0】
- [x] 增加"我的"功能【2.0】，查看当前 cookie 对应账号信息
- [ ] 添加用户注册功能【3.0】
- [x] 📡 API 文档 Postman 化改造【2.0】
- [x] ~~可对当前账号喜欢的音乐镜像操作~~【2.0】
- [x] 同步功能【2.0】，开启歌单完全匹配，同步删除本地歌曲
- [x] 🎵 音乐智能推荐【3.0】 — Librosa 基础声学维度（7 维评分，music_processor.py）
- [x] 音乐智能推荐【3.0】 — 引入 PANNs 模型，实现全自动百种标签生成（音色/流派/乐器）
- [ ] 音乐智能推荐【3.0】 — 引入 Ollama + LLM，抽取歌词高级意境主题（深夜/国风/热血）
- [ ] 音乐智能推荐【3.0】 — 引入 Demucs 声源分离，拆解人声与贝斯实现细节口味匹配
- [ ] 音乐智能推荐【3.0】 — 用户喜欢类型雷达图可视化
- [ ] 音乐智能推荐【3.0】 — 歌单解析雷达图生成
- [ ] 音乐智能推荐【3.0】 — 猜你喜欢（基于多维特征相似度推荐）
- [ ] 音乐智能推荐【3.0】 — 猜你不喜欢（歌单不喜欢音乐自动排除）
...
| **语义理解** | `Ollama` + 本地 LLM（Qwen/Llama） | 歌词意境标签（深夜emo/国风古韵/热血燃曲等） | 🔲 规划中 |
| **声源分离** | `Demucs` (Hybrid Transformer) | 人声/贝斯/鼓/伴奏独立评分，精细口味建模 | 🔲 规划中 |
